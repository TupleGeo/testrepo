# EnumDescriptionEditorControl.EnumDescriptionsListBox_SelectedValueChanged Method 
 

Occurs when the selected value of the EnumDescriptionsListBox has been changed.
...
**C#**<br />
``` C#
private void EnumDescriptionsListBox_SelectedValueChanged(
	Object sender,
	EventArgs e
)
```
