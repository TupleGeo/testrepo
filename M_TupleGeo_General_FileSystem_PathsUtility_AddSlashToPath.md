# PathsUtility.AddSlashToPath Method 
...
**C#**<br />
``` C#
public static string AddSlashToPath(
	string path
)
```
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a><br />A string representing the path with the added slash.

## Remarks
If the path ends with a slash the method returns the path as it is.
