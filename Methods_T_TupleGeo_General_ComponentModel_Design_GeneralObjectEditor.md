# GeneralObjectEditor Methods
 

The <a href="T_TupleGeo_General_ComponentModel_Design_GeneralObjectEditor">GeneralObjectEditor</a> type exposes the following members.
...
Occurs when a button has been clicked on the <a href="T_TupleGeo_General_ComponentModel_Design_GeneralObjectEditor">GeneralObjectEditor</a> control.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_ComponentModel_Design_GeneralObjectEditor_Dispose">Dispose</a></td><td>
...
<a href="#generalobjecteditor-methods">Back to Top</a>
