# GeneralObjectEditorControl Properties
 

The <a href="T_TupleGeo_General_ComponentModel_Design_GeneralObjectEditorControl">GeneralObjectEditorControl</a> type exposes the following members.
...
<a href="#generalobjecteditorcontrol-properties">Back to Top</a>
