# GeneralException Properties
 

The <a href="T_TupleGeo_General_GeneralException">GeneralException</a> type exposes the following members.
...
<a href="#generalexception-properties">Back to Top</a>
