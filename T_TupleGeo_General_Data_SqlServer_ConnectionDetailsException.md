# ConnectionDetailsException Class
 

The exception used for problems with the <a href="T_TupleGeo_General_Data_SqlServer_ConnectionDetails">ConnectionDetails</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;TupleGeo.General.Data.SqlServer.ConnectionDetailsException<br />
...
The ConnectionDetailsException type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Data_SqlServer_ConnectionDetailsException__ctor">ConnectionDetailsException()</a></td><td>
Initializes the ConnectionDetailsException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Data_SqlServer_ConnectionDetailsException__ctor_2">ConnectionDetailsException(String)</a></td><td>
Initializes the ConnectionDetailsException.</td></tr><tr><td>![Private method](media/privmethod.gif "Private method")</td><td><a href="M_TupleGeo_General_Data_SqlServer_ConnectionDetailsException__ctor_1">ConnectionDetailsException(SerializationInfo, StreamingContext)</a></td><td>
Initializes the ConnectionDetailsException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Data_SqlServer_ConnectionDetailsException__ctor_3">ConnectionDetailsException(String, Exception)</a></td><td>
Initializes the ConnectionDetailsException.</td></tr></table>&nbsp;
<a href="#connectiondetailsexception-class">Back to Top</a>
