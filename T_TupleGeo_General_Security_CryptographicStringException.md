# CryptographicStringException Class
 

The exception used for problems with the <a href="T_TupleGeo_General_Security_CryptographicString">CryptographicString</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;TupleGeo.General.Security.CryptographicStringException<br />
...
The CryptographicStringException type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Security_CryptographicStringException__ctor">CryptographicStringException()</a></td><td>
Initializes the CryptographicStringException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Security_CryptographicStringException__ctor_2">CryptographicStringException(String)</a></td><td>
Initializes the CryptographicStringException.</td></tr><tr><td>![Private method](media/privmethod.gif "Private method")</td><td><a href="M_TupleGeo_General_Security_CryptographicStringException__ctor_1">CryptographicStringException(SerializationInfo, StreamingContext)</a></td><td>
Initializes the CryptographicStringException.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_TupleGeo_General_Security_CryptographicStringException__ctor_3">CryptographicStringException(String, Exception)</a></td><td>
Initializes the CryptographicStringException.</td></tr></table>&nbsp;
<a href="#cryptographicstringexception-class">Back to Top</a>
